...
VulkDescriptorSetUpdater& VulkDescriptorSetUpdater::addUniformBuffer(VkBuffer buf, VkDeviceSize range, vulk::cpp2::VulkShaderUBOBinding bindingIn) {
...
VulkDescriptorSetUpdater& VulkDescriptorSetUpdater::addStorageBuffer(VkBuffer buf, VkDeviceSize range, vulk::cpp2::VulkShaderSSBOBinding bindingIn) {
    uint32_t binding = (uint32_t)bindingIn;
